...
// src/core/growth/referral.engine.ts
var ReferralEngine = class {
  /**
...
async function handler(req, res) {
  ...
  if (req.method === "POST") {
    try {
      ...
      const finalCode = customCode ? ReferralEngine.normalizeCode(customCode) : ReferralEngine.generateCode(referrerName.split(" ")[0]);
      const referral = db.saveReferral({
        referralCode: finalCode,
        referrerName: referrerName.trim(),
        referrerContact: referrerContact ? referrerContact.trim() : void 0,
        referredBusiness: referredBusiness ? referredBusiness.trim() : void 0,
        targetVertical: targetVertical || void 0,
        status: "CLICKED"
      });
